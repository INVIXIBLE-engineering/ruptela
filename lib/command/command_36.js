...
class Command_36 extends Command {
    ...
    execute(bufIt) {
        ...
        //Track 1
        this.data.track1_data = bufIt.readBlock(this.data.track1_len);
        ...
        //Track 1
        this.data.track2_data = bufIt.readBlock(this.data.track2_len);
        ...
        //Track 1
        this.data.track3_data = bufIt.readBlock(this.data.track3_len);
